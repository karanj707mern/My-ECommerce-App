...
/**
 * Qwik port of legacy `components/Home/TestimonialsSection.tsx`.
 *
 * Auto-advancing (11s) testimonial spotlight with dot navigation and
 * prev/next controls; pauses while the tab is hidden.
 */
export const TestimonialsSection = component$(() => {
  const testimonialIndex = useSignal(0);
  const activeTestimonial = TESTIMONIALS[testimonialIndex.value];
  ...
  return (
    ...
    >
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-10">
        ...
        <div class="overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[var(--text-primary)] via-emerald-900 to-teal-900 p-[2px] shadow-2xl">
