...
export const PAGE_CONTENT: Record<string, InfoContent> = {
  "about-us": {
    eyebrow: "About Us",
...
/**
 * Qwik port of the legacy Next.js `InfoPage` shared component.
 * Static content lives in `PAGE_CONTENT`; pages pass their `pageKey`.
 */
