import{_ as m}from"./q-BD-hIznX.js";import{y as g,a as b}from"./q-93TgTwg6.js";const U=g(b(()=>m(()=>import("./q-CSQTsADJ.js"),[]),"s_UbGDTznEtgw")),V=g(b(()=>m(()=>import("./q-TtNSd9mR.js"),[]),"s_lUpoGoFMyBw")),h=210,p=297,n=18,B=h-n*2;function i(a){return new Intl.NumberFormat("en-IN",{style:"currency",currency:"INR",minimumFractionDigits:2}).format(a)}function t(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function W(a){const{invoiceNumber:f,orderNumber:u,issuedAt:v,sellerName:x,orderTitle:y,recipient:e,items:$,subtotal:w,discountAmount:_,shippingAmount:T,handlingAmount:A,taxAmount:N,total:k}=a,r=t(x||"Moringa Store"),s=t(f),I=t(u),z=t(v),M=t(y),S=t(e.name),E=t(e.line1),d=t(e.line2||""),H=t(e.city),O=t(e.state),P=t(e.postalCode),D=t(e.country),l=t(e.phoneNumber||""),j=$.map(o=>{const c=t(o.name),q=o.quantity*o.unitPrice;return`
        <tr>
          <td>
            <div class="item">
        ...
        </tr>`}).join(""),L=d?`<p>${d}</p>`:"",R=l?`<p>${l}</p>`:"";return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>${s} — ${r}</title>
