...
export class NotificationService implements OnModuleInit, OnModuleDestroy {
   ...
   * Accepts string-typed notification input (as produced by auth.service and
   * order-notification.service) and persists a PENDING notification record.
   */
  async create(input: {
    userId?: number | null;
    orderId?: number | null;
  ...
  async queue(input: QueueNotificationInput, renderInput?: RenderTemplateInput) {
